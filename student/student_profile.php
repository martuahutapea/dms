...
?>
    ...
    <main class="content px-3 py-2">
          <div class="container-fluid">
            <div class="mb-3">
              <h1>Profile</h1>
              <h6 class="text-dark"><?= $student_firstname. ' '. $student_lastname ?></h6>
              <hr>
            </div>
...
if (isset($_POST['update_profile'])) {
    ...
    $query = "UPDATE `student` SET student_email = '$student_email', student_password = '$hashed_password', student_image = '$file_name' WHERE `student_id` = $the_student_id";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group mb-3">
        ...
        <input type="file" class="form-control" value="<?= $student_image ?>" name="picture">
    </div>
