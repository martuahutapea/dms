    ...
    if(isset($_POST['update_dean'])){   
        ...
        $dean_image = $_POST['dean_image'];
        $hall_id = $_POST['hall_id'];




        $query = "UPDATE `dean` SET dean_id = $dean_id, user_id = $user_id,  dean_firstname = '$dean_firstname', dean_lastname = '$dean_lastname',  dean_email = '$dean_email', dean_password = '$dean_password', dean_phonenumber = '$dean_phonenumber', dean_office = '$dean_office', dean_image = '$dean_image', hall_id = '$hall_id' WHERE `dean_id` = $the_dean_id";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" value="<?= $dean_image ?>" name="dean_image">
    </div>
