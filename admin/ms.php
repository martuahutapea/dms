      ...
      <ul class="sidebar-nav list-unstyled">
        ...
        <li class="sidebar-item">
          ...
          <ul id="pages" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
              ...
              <li class="sidebar-item ps-2">
                  <a href="hall.php?source=add_hall.php" class="sidebar-link">Add Hall</a>
              </li>
          </ul>
      </li>
...
<?php
    ...
    $source = '';
        ...
        switch($source){
        case 'add_ms';
        include "includes/add_ms.php";
        break;

        case 'edit_ms';
        include "includes/edit_ms.php";
        break;
...
include "includes/view_all_ms.php";
