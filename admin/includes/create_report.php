...
<?php
    if(isset($_POST['create_report'])){
        ...
        $query ="INSERT INTO report(report_id, student_id, report_titile, report_desc, report_date, report_status) 
                VALUES ('$report_id','$student_id', '$report_titile' , '$report_desc', '$report_date' ,  '$report_status')";
